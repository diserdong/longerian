...
public class TMOnePlusTwoLayout extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (childCount == 1) {
            ...
            measureChild(child,
                    MeasureSpec.makeMeasureSpec(parentWith - lp.leftMargin - lp.rightMargin,
                            MeasureSpec.EXACTLY),
            ...
            int width = (parentWith - lp1.leftMargin - lp1.rightMargin - lp2.leftMargin - lp2.rightMargin) / 2;
            measureChild(child1,
            ...
            setMeasuredDimension(getDefaultSize(getSuggestedMinimumWidth(), widthMeasureSpec),
                    Math.max(child1.getMeasuredHeight() + lp1.topMargin + lp1.bottomMargin,
                            child2.getMeasuredHeight() + lp2.topMargin + lp2.bottomMargin + child3
                                    .getMeasuredHeight() + lp3.topMargin + lp3.bottomMargin));
        }
    }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (childCount == 1) {
            ...
            final LayoutParams lp2 = (LayoutParams) child2.getLayoutParams();
            int childLeft2 = parentLeft + lp1.leftMargin + width1 + lp1.rightMargin + lp2.leftMargin;
            int childTop2 = parentTop + lp2.topMargin;
            ...
            int childTop3 = childTop2 + height2 + lp2.bottomMargin + lp3.topMargin;
